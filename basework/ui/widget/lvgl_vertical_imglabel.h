...
#ifndef BASEWORK_UI_WIDGET_IMG_VERTICAL_LABEL_H_
#define BASEWORK_UI_WIDGET_IMG_VERTICAL_LABEL_H_
...
#define IMG_VERTICAL_LABEL_MAX_COUNT    15
#define IMG_VERTICAL_LABEL_INVALID_IDX  255
...
typedef struct {
	...
	uint8_t indices[IMG_VERTICAL_LABEL_MAX_COUNT]; /* indices of the charactors to show */
	...
	uint16_t height; /* current draw charactors have the same height */
...
} lvgl_vertical_imglabel_t;

extern const lv_obj_class_t lvgl_vertical_imglabel_class;
 ...
 */
void lvgl_vertical_imglabel_split_src(lv_obj_t *obj, lv_img_dsc_t * chars, const lv_img_dsc_t * src, uint8_t cnt, bool vertical);
