 ...
 */
#ifndef BASEWORK_CONTAINER_NOTIFIER_H_
#define BASEWORK_CONTAINER_NOTIFIER_H_
 ...
 */
#define _OBSERVER_NAME(_class_name) __obs_##_class_name##__observer_list_head
#define OBSERVER_CLASS_DECLARE(_class_name) \
    extern struct observer_base *_OBSERVER_NAME(_class_name); \
...
#define OBSERVER_CLASS_INSTANCE(_class_name) \
	struct observer_base *_OBSERVER_NAME(_class_name);
...
#endif
#endif // BASEWORK_CONTAINER_NOTIFIER_H_