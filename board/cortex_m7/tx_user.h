...
/* Disable error check for tx-api */
#define TX_DISABLE_ERROR_CHECKING             1

/* Enable ram vector table */
#define TX_ENABLE_RAM_VECTOR                  1

/* Enable cortexm low-power instruction */
#define TX_ENABLE_WFI                         1

/* Enable interrupt level */
#define TX_PORT_USE_BASEPRI                   1
#define TX_PORT_BASEPRI                       0x80

/* Systick clock frequency */
#define TX_SYSTICK_FREQ                       240000000ul
